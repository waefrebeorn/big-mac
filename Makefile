...
LIBS     := third_party/SDL2-2.32.10/build/.libs/libSDL2.a \
            ...
            -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreServices -framework Security -framework CoreGraphics \
            -L/Users/waefrebeorn/homebrew/lib -lavformat -lavcodec -lswscale -lavutil -lswresample -lcurl
...
CORE_SRCS := src/wb_core.c src/wb_transport.c src/wb_cmd.c src/wb_session.c src/wb_time_sig.c \
             ...
             src/wb_session_file.c src/wb_unit.c src/wb_fm.c src/wb_fm_g2.c src/wb_fm_g3.c src/wb_synth_simd.c src/wb_drum_simd.c src/wb_granular.c src/wb_formant.c src/wb_bleep.c src/wb_kaleidoscope.c src/wb_chromakey.c src/wb_datamosh.c src/wb_audio_color.c src/wb_wah.c src/wb_char2d.c src/wb_vfx.c src/wb_vfx_node.c src/wb_light2d.c src/wb_video_edit.c src/wb_video_node.c src/wb_ytp.c src/wb_ytpmv_composite.c src/wb_keys.c src/wb_drums.c \
             src/wb_chorus.c src/wb_eq.c src/wb_automation.c src/wb_recorder.c src/wb_undo.c src/wb_unit_clap.c src/wb_midifx.c src/wb_midi_remote.c src/wb_sat_simd.c src/wb_gate.c src/wb_multiband.c src/wb_captions.c src/wb_stt_caption.c src/wb_video.c src/wb_voice_polish.c src/wb_voice_isolate.c src/wb_fft.c src/wb_param_track.c src/wb_compositor.c src/wb_compositor_pro.c src/wb_compositor_encode.c src/wb_ytpmv_lipsync.c src/wb_transcript.c src/wb_subtitle_translate.c src/wb_ofx.c src/wb_ofx_plugin_builtin.c src/wb_agent.c src/wb_text_based_edit.c src/wb_tts.c src/wb_hpss.c src/wb_workspace.c src/wb_clip_edit.c src/wb_cgi.c src/wb_agi.c src/wb_rast.c src/wb_mesh.c src/wb_anim.c src/wb_bvh.c src/wb_mod.c src/wb_gltf.c src/wb_assets.c src/wb_cgiexport.c src/wb_shadowbin.c src/wb_duck.c src/wb_delivery.c src/wb_perf.c src/wb_perfclip.c src/wb_wavcache.c src/wb_import.c src/wb_capture.c src/wb_export_job.c src/wb_precision.c src/wb_lufs.c src/wb_ai_mix.c src/wb_input.c src/wb_limiter.c src/wb_master_adv.c src/wb_mastering_pro.c src/wb_cgi_react.c src/wb_cgi_bands.c src/wb_timestretch.c src/wb_smf.c src/wb_sf2.c src/wb_bitcrush.c src/wb_sfx.c src/wb_waveview.c src/wb_scenedesc.c src/wb_pattern.c src/wb_tga.c src/wb_csg.c src/wb_graphio.c src/wb_conv.c src/wb_biquad_cascade_simd.c src/wb_comp_simd.c src/wb_mix_simd.c src/wb_stereo.c src/wb_yin.c src/wb_tempo_detect.c src/wb_phaser.c src/wb_pitch_correct.c src/wb_ladder.c src/wb_drum_machine.c src/wb_drum_rack.c src/wb_fuzz.c src/wb_karplus.c src/wb_macro_rack.c src/wb_bass_boost.c src/wb_meme_sounds.c src/wb_beat_sync.c src/wb_auto_captions.c src/wb_chroma_key.c src/wb_stutter.c src/wb_transitions.c src/wb_transitions_pro.c src/wb_ftz.c src/wb_sidechain.c src/wb_pitch_bend.c src/wb_audio_reactive.c src/wb_audio_reactive_node.c src/wb_video_fx_pro.c src/wb_lut_node.c src/wb_motion_overlay.c src/wb_motion_blur.c src/wb_mesh_warp.c src/wb_tape_stop.c src/wb_spectrum.c src/wb_beat_slicer.c src/wb_parallel_comp.c src/wb_lfo_sidechain.c src/wb_deep_fry.c src/wb_vhs_effect.c src/wb_lyric_video.c src/wb_speed_ramp.c src/wb_transient_shaper.c src/wb_deesser.c src/wb_exciter.c src/wb_text_animate.c src/wb_text_edit.c src/wb_particle.c src/wb_particle_gpu.c src/wb_true_peak.c src/wb_dynamic_eq.c src/wb_stereo_image.c src/wb_mod_matrix.c src/wb_stabilize.c src/wb_stabilize2.c src/wb_chord_detect.c src/wb_audio_to_midi.c src/wb_cloud.c src/wb_cloud_collab.c src/wb_chord_ai.c src/wb_arrange_ai.c src/wb_arpeggiator.c src/wb_quantize.c src/wb_restore.c src/wb_freeze.c src/wb_spectral_edit.c src/wb_vocal_remove.c src/wb_midi_humanize.c src/wb_color_grading.c src/wb_comping.c src/wb_vca.c src/wb_mastering_chain.c src/wb_stem_export.c src/wb_reaction.c src/wb_keyframes.c src/wb_scene_detect.c src/wb_lut.c src/wb_motion_track.c src/wb_text_templates.c src/wb_surround.c src/wb_export_queue.c src/wb_midi_chordgen.c src/wb_proxy.c src/wb_midi_scale.c src/wb_midi_generators.c src/wb_melody_ai.c src/wb_aaf_export.c src/wb_track_folder.c src/wb_warp.c src/wb_vocal_synth.c src/wb_project_templates.c src/wb_wavetable.c src/wb_spatial_audio.c src/wb_linked_tracks.c src/wb_stem_split.c src/wb_autoreframe.c src/wb_dynamics_adv.c src/wb_lottie.c src/wb_sonogram.c src/wb_score.c src/wb_session_view.c src/wb_spectral_fx.c src/wb_edit.c src/wb_edit_serialize.c src/wb_edit_undo.c src/wb_multicam.c src/wb_audio_fx.c src/wb_audio_mixer.c src/wb_audio_mix.c src/wb_audio_mux.c src/wb_noise_gate.c src/wb_gif_export.c src/wb_composite_ext.c src/wb_shape_node.c src/wb_mask_node.c src/wb_text_animator.c src/wb_expressions.c src/wb_screen_record.c src/wb_null_object.c src/wb_3d_camera.c src/wb_realtime_preview.c src/wb_dvd_author.c src/wb_hdr_preview.c src/wb_youtube_upload.c src/wb_svg_import.c src/wb_sdl_preview.c src/wb_vst3_editor.c src/wb_ffmpeg_filters.c src/wb_chromakey.c src/wb_chromakey_engine.c src/wb_ytp_fx.c src/wb_ytpmv.c src/wb_dark_arts.c src/wb_ytp_combo.c src/wb_ytp_remaining.c src/wb_ytpmv_sync.c src/wb_vgm.c src/wb_ytpmv_machine.c src/wb_3d_overlay.c src/wb_ytp_video_fx.c src/wb_ytpmv_renderer.c src/wb_ytp_glitch.c src/wb_sampler_inst.c src/wb_composition.c src/wb_ytpmv_prod.c src/wb_prod_project.c src/wb_matte_fx.c src/wb_beat_grid.c src/wb_melody_follow.c src/wb_phoneme_seg.c src/wb_ytpmv_engine.c src/wb_ytpmv_vfx.c src/wb_ytpmv_multi.c src/wb_ytpmv_vfx_pipeline.c src/wb_ytpmv_library.c
...
# ---- text-based editing test (R086) ----
build/wb_test_text_based_edit: tests/test_text_based_edit.c $(CORE_OBJS)
	$(CC) $(CFLAGS) $(INC) -c tests/test_text_based_edit.c -o build/test_text_based_edit.o
	$(CXX) $(CXXFLAGS) $(INC) -o $@ build/test_text_based_edit.o $(CORE_OBJS) -lm $(LIBS)

test_text_based_edit: build/wb_test_text_based_edit
	./build/wb_test_text_based_edit
...
# ---- STT caption test (C++ extern "C" for engine linkage) ----
build/wb_test_stt_caption: tests/test_stt_caption.c build/src/wb_stt_caption.o $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -c tests/test_stt_caption.c -o build/test_stt_caption.o
	$(CXX) $(CXXFLAGS) $(INC) -o $@ build/test_stt_caption.o $(CORE_OBJS) -lm $(LIBS)

test_stt_caption: build/wb_test_stt_caption
	./build/wb_test_stt_caption
...
build/wb_mk_smb_ytpmv: build/tools/mk_smb_ytpmv.o $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $^ -lm $(LIBS)

mk_smb_ytpmv: build/wb_mk_smb_ytpmv
	./build/wb_mk_smb_ytpmv

build/wb_mk_ytpmv_ffmpeg: build/tools/mk_ytpmv_ffmpeg.o $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $^ -lm $(LIBS)
...
# ---- motion blur effect node test (R086) ----
build/wb_test_motion_blur: tests/test_motion_blur.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ tests/test_motion_blur.c $(CORE_OBJS) -lm $(LIBS)
...
build/wb_test_expressions: tests/test_expressions.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_expressions: build/wb_test_expressions
	./build/wb_test_expressions

build/wb_test_screen_record: tests/test_screen_record.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_screen_record: build/wb_test_screen_record
	./build/wb_test_screen_record

build/wb_test_null_object: tests/test_null_object.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_null_object: build/wb_test_null_object
	./build/wb_test_null_object

build/wb_test_3d_camera: tests/test_3d_camera.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_3d_camera: build/wb_test_3d_camera
	./build/wb_test_3d_camera

build/wb_test_realtime_preview: tests/test_realtime_preview.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_realtime_preview: build/wb_test_realtime_preview
	./build/wb_test_realtime_preview

build/wb_test_dvd_author: tests/test_dvd_author.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)
test_dvd_author: build/wb_test_dvd_author
	./build/wb_test_dvd_author

build/wb_test_dvd_vm: tests/test_dvd_vm.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)
...
test_hdr_preview: build/wb_test_hdr_preview
	./build/wb_test_hdr_preview

build/wb_test_svg_import: tests/test_svg_import.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)
test_svg_import: build/wb_test_svg_import
	./build/wb_test_svg_import

build/wb_test_youtube_upload: tests/test_youtube_upload.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)
test_youtube_upload: build/wb_test_youtube_upload
	./build/wb_test_youtube_upload
...
build/wb_test_ffmpeg_filters: tests/test_ffmpeg_filters.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ffmpeg_filters: build/wb_test_ffmpeg_filters
	./build/wb_test_ffmpeg_filters

build/wb_test_chromakey: tests/test_chromakey.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_chromakey: build/wb_test_chromakey
	./build/wb_test_chromakey

# ---- YTP Effects Engine test (R094) ----
build/wb_test_ytp_fx: tests/test_ytp_fx.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytp_fx: build/wb_test_ytp_fx
	./build/wb_test_ytp_fx

# ---- YTPMV + Dark Arts test (R094b/c) ----
build/wb_test_ytpmv_darkarts: tests/test_ytpmv_darkarts.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_darkarts: build/wb_test_ytpmv_darkarts
	./build/wb_test_ytpmv_darkarts

# ---- YTP Combo Effects test (R094f) ----
build/wb_test_ytp_combo: tests/test_ytp_combo.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytp_combo: build/wb_test_ytp_combo
	./build/wb_test_ytp_combo

# ---- YTP Remaining test (R094g) ----
build/wb_test_ytp_remaining: tests/test_ytp_remaining.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytp_remaining: build/wb_test_ytp_remaining
	./build/wb_test_ytp_remaining

# ---- YTPMV Sync Engine test (R095) ----
build/wb_test_ytpmv_sync: tests/test_ytpmv_sync.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_sync: build/wb_test_ytpmv_sync
	./build/wb_test_ytpmv_sync

# ---- VGMusic MIDI Parser test (R096) ----
build/wb_test_vgm: tests/test_vgm.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_vgm: build/wb_test_vgm
	./build/wb_test_vgm

# ---- YTPMV Machine test (R097) ----
build/wb_test_ytpmv_machine: tests/test_ytpmv_machine.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_machine: build/wb_test_ytpmv_machine
	./build/wb_test_ytpmv_machine

# ---- 3D Overlay test (R098) ----
build/wb_test_3d_overlay: tests/test_3d_overlay.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_3d_overlay: build/wb_test_3d_overlay
	./build/wb_test_3d_overlay

# ---- R099 Video Poopisms test ----
build/wb_test_ytp_video_fx: tests/test_ytp_video_fx.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytp_video_fx: build/wb_test_ytp_video_fx
	./build/wb_test_ytp_video_fx

# ---- R100 YTPMV Renderer test ----
build/wb_test_ytpmv_renderer: tests/test_ytpmv_renderer.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_renderer: build/wb_test_ytpmv_renderer
	./build/wb_test_ytpmv_renderer

# ---- R101 Glitch Effects test ----
build/wb_test_ytp_glitch: tests/test_ytp_glitch.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytp_glitch: build/wb_test_ytp_glitch
	./build/wb_test_ytp_glitch

# ---- R108 Matte Painting + Cutout test ----
build/wb_test_matte_fx: tests/test_matte_fx.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_matte_fx: build/wb_test_matte_fx
	./build/wb_test_matte_fx

# ---- R128 VFX Engine test ----
build/wb_test_ytpmv_vfx: tests/test_ytpmv_vfx.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_vfx: build/wb_test_ytpmv_vfx
	./build/wb_test_ytpmv_vfx

# ---- R131 Multi-Character Engine test ----
build/wb_test_ytpmv_multi: tests/test_ytpmv_multi.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_multi: build/wb_test_ytpmv_multi
	./build/wb_test_ytpmv_multi

# ---- R135 Source Library test ----
build/wb_test_ytpmv_library: tests/test_ytpmv_library.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_library: build/wb_test_ytpmv_library
	./build/wb_test_ytpmv_library

# ---- R131b Lip-Sync / Viseme Engine test ----
build/wb_test_ytpmv_lipsync: tests/test_ytpmv_lipsync.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_lipsync: build/wb_test_ytpmv_lipsync
	./build/wb_test_ytpmv_lipsync

# ---- YTPMV Compositing Engine test ----
build/wb_test_ytpmv_composite: tests/test_ytpmv_composite.c build/src/wb_ytpmv_composite.o
	$(CC) $(CFLAGS) $(INC) -o $@ tests/test_ytpmv_composite.c build/src/wb_ytpmv_composite.o -lm

test_ytpmv_composite: build/wb_test_ytpmv_composite
	./build/wb_test_ytpmv_composite

# ---- R109 Beat Grid test ----
build/wb_test_beat_grid: tests/test_beat_grid.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_beat_grid: build/wb_test_beat_grid
	./build/wb_test_beat_grid

# ---- R112 Melody Follow test ----
build/wb_test_melody_follow: tests/test_melody_follow.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_melody_follow: build/wb_test_melody_follow
	./build/wb_test_melody_follow

# ---- R102 Sampler + Piano Roll test ----
build/wb_test_sampler_inst: tests/test_sampler_inst.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_sampler_inst: build/wb_test_sampler_inst
	./build/wb_test_sampler_inst

# ---- R103 Composition test ----
build/wb_test_composition: tests/test_composition.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_composition: build/wb_test_composition
	./build/wb_test_composition

# ---- R104 YTPMV Production test ----
build/wb_test_ytpmv_prod: tests/test_ytpmv_prod.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_ytpmv_prod: build/wb_test_ytpmv_prod
	./build/wb_test_ytpmv_prod
...
# ---- Mesh warp / puppet tool test (R086) ----
build/wb_test_mesh_warp: tests/test_mesh_warp.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_mesh_warp: build/wb_test_mesh_warp
	./build/wb_test_mesh_warp
...
# ---- stereoscopic 3D edit test (standalone: only needs wb_3d_edit.o) ----
build/wb_test_3d_edit: tests/test_3d_edit.c build/src/wb_3d_edit.o
	$(CC) $(CFLAGS) $(INC) -o $@ tests/test_3d_edit.c build/src/wb_3d_edit.o -lm

test_3d_edit: build/wb_test_3d_edit
	./build/wb_test_3d_edit
...
# ---- Per-layer mask node test (R090) ----
build/wb_test_mask_node: tests/test_mask_node.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -o $@ $< $(filter %.o,$^) $(LIBS)

test_mask_node: build/wb_test_mask_node
	./build/wb_test_mask_node

# ---- SDL preview window (standalone) ----
build/wb_sdl_preview: src/wb_sdl_preview.c $(CORE_OBJS)
	$(CXX) $(CXXFLAGS) $(INC) -DBUILD_STANDALONE -o $@ src/wb_sdl_preview.c $(CORE_OBJS) $(LIBS)

sdl_preview: build/wb_sdl_preview
	./build/wb_sdl_preview
