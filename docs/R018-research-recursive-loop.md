...
2. R018-B HDR/wide-gamut color pipeline — OPEN (next highest leverage).
3. R018-C FCPXML intent enrichment (color/audio) — OPEN.
4. R018-D voice isolation (spectral, self-contained FFT) — ✅ DONE (this commit).
5. Re-open loop: HOP 3 recon on HDR color pipeline / Metal GPU / BRAW decode — next.
