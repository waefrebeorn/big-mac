...
3. R018-C FCPXML intent enrichment (color/audio) — ✅ DONE (e6b40b3).
4. R018-D voice isolation (spectral, self-contained FFT) — ✅ DONE (7827607).
5. R018-G live loudness meter (gated integrated + short-term LUFS) — ✅ DONE (this commit).
6. Re-open loop: HOP 6 recon on BRAW decode / Metal GPU / auto-reframe — next.
