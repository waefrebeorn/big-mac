...
67. G-SF067 No tempo map / BPM automation
68. G-SF068 No pattern sequencer (loops written as raw samples)
69. G-SF069 No sidechain-triggered duck tied to video events
70. G-SF070 Engine SFX: no procedural laser/explosion synth presets
71. G-SF071 No stereo pan automation per note
72. G-SF072 No reverb send routing verified for game-style ambience
73. G-SF073 Audio mux done by external ffmpeg — no internal AAC encode
74. G-SF074 No loudness normalization on the demo path (wb_delivery exists but unused)
75. G-SF075 No loop-region playback for previewing sections
76. G-SF076 No MIDI file export (compose in engine, save .mid)
...
81. G-SF081 No render queue (batch multiple demos)
82. G-SF082 No --quality flag (draft vs final passes)
...
86. G-SF086 No --preview lowres fast pass flag
...
89. G-SF089 No error surfacing when wb_anim_add_object hits cap (rc ignored)
...
96. G-SF096 Memory: meshes copied per object without sharing/refcount
97. G-SF097 No deterministic float policy (render reproducibility across runs)
