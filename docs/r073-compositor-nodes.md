...
- Nested transitions compose as graph inputs (T2(T1(A,B),C)) — proven
  by the hop-106 showcase demo. Titles overlay via
  `wb_node_composite` (bottom..top, alpha-over); composite owns children.
